...
class application
{
	...
	{
		$file = "signin/application/controllers/".$this->uri['controller'].".php";
...
class controller
{
	...
	{
		require_once( 'signin/application/models/'. $model .'.php' );
		return new $model;
	} 
	...
	function loadView( $view, $vars="" )
	{
		...
		require_once( 'signin/application/views/'.$view.'.html' );
	}
